...
public class ElasticsearchUtils {
    ...
    public static String getTableNameFromIndex(String index) {
        if (index.contains(TABLENAME_PREFIX) && index.contains(TABLENAME_POSTFIX)) {
            String tempIndex = index.substring(index.indexOf(TABLENAME_PREFIX) + TABLENAME_PREFIX.length() + 1);
    ...
    public static DateTime getCreationDateFromIndex(String index) {
